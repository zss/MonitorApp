...
@SuppressLint("NewApi")
public abstract class BaseRecyleListFragment<T extends Entity> extends BaseFragment {
    ...
    protected int getLayoutId() {
        return R.layout.fragment_pull_refresh_recyle_listview_simple;
    }
    ...
    protected void initSearchMenuView(){
    ...
    protected void setOnRecyclerItemClickListener(OnRecyclerItemClicklistener onRecyclerItemClickListener){
        if(onRecyclerItemClickListener != null) mListView.addOnItemTouchListener(onRecyclerItemClickListener);
    }
    ...
    protected TextHttpResponseHandler mHandler = new TextHttpResponseHandler() {
        ...
        public void onFailure(int statusCode, Header[] headers, String responseString, Throwable throwable) {
            if(isAdded()) {
                executeOnLoadDataError(getActivity().getResources().getString(R.string.tip_network_req_error));
            }
        }
