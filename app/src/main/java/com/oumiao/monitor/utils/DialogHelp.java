...
public class DialogHelp {
    ...
    public static ProgressDialog getWaitDialog(Context context){
        return getWaitDialog(context,context.getResources().getString(R.string.loading));
    }
     ...
     * @return
     */
    public static AlertDialog.Builder getMessageDialog(Context context, int messageId, DialogInterface.OnClickListener onClickListener){
        return getMessageDialog(context, context.getResources().getString(messageId), onClickListener);
    }
    ...
    public static AlertDialog.Builder getMessageDialog(Context context, int messageId){
    ...
    public static AlertDialog.Builder getConfirmDialog(Context context, String message, DialogInterface.OnClickListener onOkClickListener, DialogInterface.OnClickListener onCancleClickListener) {
        ...
        builder.setNegativeButton(R.string.cancel, onCancleClickListener);
        return builder;
    }
