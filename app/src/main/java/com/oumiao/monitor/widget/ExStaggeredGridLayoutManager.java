...
/**
 * @description StaggeredGridLayoutManager和ScrollView进行嵌套 自适应
 * @user zss
 * @date 2016/4/27
 * @email zss_503@163.com
 */
public class ExStaggeredGridLayoutManager extends android.support.v7.widget.StaggeredGridLayoutManager {
